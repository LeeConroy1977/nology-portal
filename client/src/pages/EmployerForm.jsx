...
const EmployerForm = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-start items-center bg-[#F2F2F2]">
      ...
      <form
        action="submit"
        className="flex flex-col justify-start items-center w-[88%] sm:w-[80%] md:w-[50%] lg:w-[40%] xl:w-[36%] 2xl:w-[30%] h-[76%] sm:h-[80%] md:h-[74%] lg:h-[78%] bg-white mt-3 sm:mt-6 xl:mt-10 p-6 sm:p-8 gap-2 rounded-lg">
